...
import { Sparkles, Loader2, Pencil, Send, CheckCircle2, XCircle, X, Wand2, ChevronRight, Trash2, Mic, ArrowUpRight, FileText, Briefcase, Lightbulb, Gauge, MessageSquareText, ChevronDown } from "lucide-react";
